...
print 'read start'
n = input()
dt = [["" for j in range(5000)] for i in range(n)]
evt = [[0 for j in range(5000)] for i in range(n)]
ftr = [[[0.0 for k in range(6)] for j in range(5000)] for i in range(n)]
lbl = [[[0.0 for k in range(5)] for j in range(3682)] for i in range(n)]
pt = []
pNum = 0
